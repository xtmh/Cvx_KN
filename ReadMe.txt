================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Cve プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Cve には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Cve アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Cve.h
   ...
   CCveApp アプリケーション クラスを宣言します。

Cve.cpp
   これは、アプリケーション クラス CCveApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Cve.ico
   ...
   アイコンはメイン リソース ファイル Cve.rc に含まれていま
   す。
...
CveDlg.h, CveDlg.cpp - ダイアログ
   これらのファイルは CCveDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Cve.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Cve.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
